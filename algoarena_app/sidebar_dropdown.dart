...
import 'package:algoarena/data/models/user.dart';
...
/// - Menu slides up from bottom with fade animation
...
class _SideMenuState extends State<SideMenu> with SingleTickerProviderStateMixin {
  ...
  /// Build individual menu item with transparent white background
