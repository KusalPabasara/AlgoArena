...
class ResponsiveUtils {
  ...
  // ============================================================
  // BUBBLE RESPONSIVE POSITIONING
  // Reference: Pixel 9 Pro (412 x 915 dp)
  // Bubbles should scale relative to screen size
  // ============================================================
  
  /// Scale width value relative to reference width (412dp)
  /// Use for horizontal positions and widths of bubbles
  static double bw(double value) {
    final ratio = screenWidth / _referenceWidth;
    return value * ratio;
  }
  
  /// Scale height value relative to reference height (915dp)
  /// Use for vertical positions and heights of bubbles
  static double bh(double value) {
    final ratio = screenHeight / _referenceHeight;
    return value * ratio;
  }
  
  /// Scale bubble size uniformly (uses smaller ratio to maintain proportions)
  /// Use for bubble width/height to keep consistent appearance
  static double bs(double value) {
    final widthRatio = screenWidth / _referenceWidth;
    final heightRatio = screenHeight / _referenceHeight;
    // Use the smaller ratio to prevent bubbles from overflowing
    final ratio = widthRatio < heightRatio ? widthRatio : heightRatio;
    return value * ratio;
  }
  
  /// Get width ratio compared to reference device
  static double get widthRatio => screenWidth / _referenceWidth;
  
  /// Get height ratio compared to reference device
  static double get heightRatio => screenHeight / _referenceHeight;
}
