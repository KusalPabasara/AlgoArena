...
class LikeCommentManager {
  // Singleton pattern
  static final LikeCommentManager _instance = LikeCommentManager._internal();
  factory LikeCommentManager() => _instance;
  LikeCommentManager._internal();
  ...
  List<Map<String, dynamic>> getLocalComments(String postId) {
