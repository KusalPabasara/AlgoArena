import svgPaths from "./imports/svg-ceufdigd48";
...
function Group1() {
  return (
    <div className="absolute contents left-[73px] top-[473px]">
      <div className="absolute h-[64px] left-[73px] top-[473px] w-[188px]" data-name="-SriLanka-Maldives-Black-Version-1 1">
      ...
      <div className="absolute h-[64px] left-[261px] top-[473px] w-[67px]" data-name="leo1 1">
...
function Group() {
  return (
    <div className="h-[32.195px] relative w-[33px]">
  ...
  return (
    <div className="absolute bottom-0 left-0 right-[2.33px] top-0" data-name="Border">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 12">
        <g clipPath="url(#clip0_1_107)" id="Border">
          <g id="Shape"></g>
          <mask height="12" id="mask0_1_107" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="22" x="0" y="0">
  ...
  return (
    <div className="absolute h-[4px] right-0 top-1/2 translate-y-[-50%] w-[1.328px]" data-name="Cap">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 4">
        <g id="Cap">
          <g id="Shape"></g>
          <mask height="4" id="mask0_1_81" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="2" x="0" y="0">
  ...
  return (
    <div className="absolute h-[7.333px] left-[2px] top-1/2 translate-y-[-50%] w-[18px]" data-name="Capacity">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 8">
        <g id="Capacity">
          <g id="Shape"></g>
          <mask height="8" id="mask0_1_76" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="18" x="0" y="0">
  ...
  return (
    <div className="absolute h-[10.966px] overflow-clip right-[54.03px] top-[calc(50%+0.81px)] translate-y-[-50%] w-[15.272px]" data-name="Wifi">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 11">
        <g clipPath="url(#clip0_1_94)" id="Wifi">
          <g id="Shape"></g>
          <mask height="11" id="mask0_1_94" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="16" x="0" y="0">
  ...
  return (
    <div className="absolute h-[10.667px] left-[calc(50%+104.17px)] overflow-clip top-[calc(50%+1px)] translate-x-[-50%] translate-y-[-50%] w-[17px]" data-name="Cellular Connection">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 11">
        <g clipPath="url(#clip0_1_63)" id="Cellular Connection">
          <g id="Shape"></g>
          <mask height="11" id="mask0_1_63" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="17" x="0" y="0">
...
export default function Start() {
  return (
    <div className="bg-white relative size-full" data-name="Start">
      <Bar />
      <Group1 />
      <div className="absolute h-[424px] left-[101px] top-0 w-[353px]" data-name="3f3f7674ead2dca54ee11da58cb3d19ssssb 1">
      ...
      <div className="absolute flex h-[33px] items-center justify-center left-[186px] top-[724px] w-[32.195px]" style={{ "--transform-inner-width": "33", "--transform-inner-height": "32" } as React.CSSProperties}>
