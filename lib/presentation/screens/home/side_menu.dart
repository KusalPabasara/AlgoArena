...
class _SideMenuState extends State<SideMenu> with SingleTickerProviderStateMixin {
  ...
  Future<void> _waitForAnimationComplete() async {
    if (_controller.isAnimating) {
      // Wait for animation to complete using a completer
    ...
    return Material(
      ...
      child: InkWell(
        onTap: () async {
          ...
          try {
            // Store the navigation callback before closing menu
            ...
            // Ensure context is still valid and widget is mounted before navigating
            ...
            debugPrint('Menu navigation error: $e');
          } finally {
            // Reset flag after a delay to allow next navigation
